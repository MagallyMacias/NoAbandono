...
@section('titulo','Cambiar contraseña padre de familia')
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6 ml-auto mr-auto">
          <div class="card card-login">
            <form class="form-horizontal" method="POST" action="{{ route('padre.password.request') }}">
                {{csrf_field()}}
                <input type="hidden" name="token" value="{{ $token }}">
                <div class="card-header card-header-primary text-center">
                  <h4 class="card-title">Cambiar Contraseña del Padre de familia</h4>
